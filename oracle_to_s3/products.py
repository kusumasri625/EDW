...
sql_query = f"""SELECT PRODUCTCODE,PRODUCTNAME,PRODUCTLINE,PRODUCTSCALE,PRODUCTVENDOR,
                QUANTITYINSTOCK,BUYPRICE,MSRP,CREATE_TIMESTAMP,UPDATE_TIMESTAMP FROM products@f23kusumasri_dblink_classicmodels
...
csv_file_path = export_to_csv(sql_query, "products.csv")
