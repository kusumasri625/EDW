...
sql_query = f"""select * from offices@f23kusumasri_dblink_classicmodels where to_char(update_timestamp,'YYYY-MM-DD')>='${ETL_BATCH_DATE}'"""
...
csv_file_path = export_to_csv(sql_query, "offices.csv")
